    ...
    <aside className="fixed left-0 top-0 h-screen w-60 bg-zinc-900 border-r border-zinc-800 flex flex-col z-40">
      ...
      <div className="px-5 py-5 border-b border-zinc-800">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-semibold text-zinc-50 tracking-tight">Edge Intelligence</span>
        </div>
        {upgradeStatus === 'free' && (
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isLocked && <Lock className="w-3 h-3 ml-auto text-zinc-600" />}
              {isActive && !isLocked && (
      ...
      <div className="p-4 border-t border-zinc-800">
        ...
        {upgradeStatus === 'premium' && (
          <div className="text-xs text-zinc-500 text-center">Premium plan active</div>
        )}
      </div>
    </aside>
  )
