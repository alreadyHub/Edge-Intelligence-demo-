...
interface EmpTooltipPayload { name: string; value?: number }
interface EmpTooltipProps { active?: boolean; payload?: EmpTooltipPayload[]; label?: string }

const CustomTooltip = ({ active, payload, label }: EmpTooltipProps) => {
